namespace Gazette
{
	partial class MainMenu
	{
		...
		private void InitializeComponent()
		{
			...
			this.button1.Click += new System.EventHandler(this.ButtonHost_Click);
			// 
			// button2
			// 
			...
			this.button2.Click += new System.EventHandler(this.ButtonJoin_Click);
			// 
			// button3
			// 
			...
			this.button3.Click += new System.EventHandler(this.ButtonQuit_Click);
			// 
			// MainMenu
			// 
